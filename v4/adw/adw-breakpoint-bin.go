...
func (x *BreakpointBin) UpdatePropertyValue(NPropertiesVar int, PropertiesVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *BreakpointBin) UpdateRelationValue(NRelationsVar int, RelationsVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *BreakpointBin) UpdateStateValue(NStatesVar int, StatesVar uintptr, ValuesVar uintptr) {
