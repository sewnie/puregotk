...
func (x *ViewSwitcher) UpdatePropertyValue(NPropertiesVar int, PropertiesVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *ViewSwitcher) UpdateRelationValue(NRelationsVar int, RelationsVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *ViewSwitcher) UpdateStateValue(NStatesVar int, StatesVar uintptr, ValuesVar uintptr) {
